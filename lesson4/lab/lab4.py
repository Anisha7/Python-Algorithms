...
def drawStar(canvas, centerX, centerY, diameter, numPoints, color):
    ...
    L = getStarPoints(canvas, centerX, centerY, diameter, numPoints, color)
    pointList = L
...
def drawRedStripes(canvas, winWidth, winHeight):
    #root = Tk()
...
def drawUnitedStatesFlag(winWidth=950, winHeight=500):
    ...
    #red stripes
    drawRedStripes(canvas, winWidth, winHeight)
